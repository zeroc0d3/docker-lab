...
" Vim UI {
    ...
    if !exists('g:override_spf13_bundles') && filereadable(expand("~/.vim/bundle/vim-colorschemes/colors/solarized.vim"))
        " let g:airline_theme='railscasts'
...
" Formatting {
    ...
    "   let g:spf13_keep_trailing_whitespace = 1i now.
    ...
    if has('gui_running')
        ...
        if !exists("g:spf13_no_big_font")
            if LINUX() && has("gui_running")
                set guifont=Andale\ Mono\ Regular\ 11,Menlo\ Regular\ 10,Consolas\ Regular\ 11,Courier\ New\ Regular\ 11
            elseif OSX() && has("gui_running")
                set guifont=Andale\ Mono\ Regular:h11,Menlo\ Regular:h10,Consolas\ Regular:h11,Courier\ New\ Regular:h11
